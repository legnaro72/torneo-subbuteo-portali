...
import {ArrowUpRight, ArrowRight, Check, Flag, LayoutDashboard, LogOut, Plus, Search, ShieldCheck, Shuffle, Trophy, Users, X, CalendarDays, LockKeyhole} from 'lucide-react';
  ...
  return <div className="shell">
    <aside className="sidebar">
      ...
      <nav aria-label="Navigazione principale">
        ...
        <button className={page === 'svizzero' ? 'selected' : ''} aria-current={page==='svizzero'?'page':undefined} onClick={() => navigate('svizzero')}><Shuffle size={19}/><span>Svizzero</span></button>
      </nav>
    ...
    <main>
      ...
      <div className="content">
        ...
        <footer>SUPERBA SUBBUTEO CLUB<span className="site-credit">© 2026 Legnaro 72 · Un piccolo campo, una grande passione.</span></footer>
      </div>
    </main>
