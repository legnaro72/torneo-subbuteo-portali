...
export default function ClubView({user,canWrite,onDirty,onLegacy}:{user:User;canWrite:boolean;onDirty:(value:boolean)=>void;onLegacy:()=>void}){
  ...
  return <>
    <section className="page-heading"><div><span className="eyebrow">TIGULLIO CLUB · ANAGRAFICA E ARCHIVIO</span><h1>Gestione club</h1><p>Giocatori, palmarès e tornei del mondo Tigullio.</p></div><button className="secondary" disabled={busy} onClick={()=>void refresh()}><RefreshCw size={16}/>Aggiorna</button></section>
